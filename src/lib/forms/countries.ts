/** Country data for the phone field's country-code picker. */
...
// [iso2, name, dial code] — sorted by name. Full ISO 3166-1 sovereign states + common territories.
...
export function countryByIso(iso: string | undefined): Country {
  return COUNTRIES.find((c) => c.iso === iso) ?? COUNTRIES.find((c) => c.iso === DEFAULT_COUNTRY_ISO)!;
}
