...
const ALL_TABS = new Set([
  ...
  "pages", "collections", "components", "publishing",
]);
...
const MARKETER_TABS = new Set(["content", "pages", "collections", "visual", "agent", "media", "seo", "analytics"]);
// Content editor: writes and reviews entries, nothing structural.
const EDITOR_TABS = new Set(["collections", "visual", "media", "agent"]);
// Reviewer: reads and comments, nothing else.
const REVIEWER_TABS = new Set(["collections", "visual"]);
